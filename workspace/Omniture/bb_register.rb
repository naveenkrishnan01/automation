...
require '/Users/nkrishna/workspace/test/clicks.rb'
...
if y == '' || y == 'livestg' || y == 'prod'
 browser.element(:xpath, "html/body/div[5]/div[2]/div/ul[2]/li[3]/div[2]/a").click; #signin - xpath
 ...
 browser.goto 'http://ownaccess:oprah@betamyown.oprah.com/dump.html'
 browser.goto 'http://ownaccess:oprah@betastg.oprah.com/index.html/own-brene-brown-course/lifeclass-presents-brene-brown-online-course.html?LoginRegister_action=1&visited_market_landing=1'
 click_count += 1
 sleep 5;
...
if browser.element(:xpath => ".//*[@id='submit_reg_btn']").exists?
    puts " Join now button clicked on the New registration for Brene Brown".green
    f.puts "Join now button clicked on the New registration for Brene Brown page"
else
    f.puts "Issue with the Join now button new registration for Brene Brown  page "
end
