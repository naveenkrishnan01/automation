...
#myusername = "nikumar" + randnum # need to get this value from db
myusername = "nikumar11700"
...
# On the join page enter required fields to create own account

username = driver.find_element(:name, 'login_email_username')
username.send_keys(myusername)
password = driver.find_element(:name, 'login_password')
password.send_keys(mypassword)

login_button = driver.find_element(:xpath, '//input[contains(@title, "Log In")]')
login_button.click
...
# Verify user lands on reg checkout page
...
# Verify correct total price on checkout page
...
# Verify after purchase user lands on thank you page
