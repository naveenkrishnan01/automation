...
t = browser.div(:class, "sharebar_envelope_icon")
 if t.exists?
  puts "The Envelope Email Icon is found and clicked on the article page /food/What-Do-You-Want-to-Eat".green
  f.puts "The Envelope Email Icon is found and clicked on the article page /food/What-Do-You-Want-to-Eat"
 else
  puts "The Envelope Email Icon icon is NOT found on the article page".red
      f.puts "The Envelope Email Icon is NOT found in the article page"
 end
...
puts "Test now complete for Envelope Email icon on the article page /food/What-Do-You-Want-to-Eat".green
f.puts "Test now complete for envelope Email icon the article page /food/What-Do-You-Want-to-Eat"
