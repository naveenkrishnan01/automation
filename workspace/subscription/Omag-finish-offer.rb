...
sleep 2;
browser.driver.save_screenshot("./before-Omag-Finish.png")
sleep 3;
#****************************
...
sleep 2;
browser.driver.save_screenshot("./After-Omag-Finish.png")

puts "Test now complete for Omag Subscription for News letter checked redirecting to originating page.This is for the Finish button".green
f.puts "Test now complete for Omag Subscription for News letter checked redirecting to originating page.This is for the Finish button"
...
browser.close
  ...
  puts e
  puts 'problem with form submission for Omag Subscription for News letter checked.This is for Finish button'.red 
  f.puts 'problem with form submission for Omag Subscription for News letter checked. This is for Finish button' 
 browser.close
 f.puts ' '
 f.close
end
