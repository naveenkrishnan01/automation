...
sleep 2;
browser.driver.save_screenshot("./before-Omag-skipoffer.png")
sleep 3;
#****************************
# click the account settings and manage_news_letter to validate
#*******************************

browser.button(:name => 'skip').click;
sleep 3;
...
sleep 2;
browser.driver.save_screenshot("./After-Omag-skipoffer.png")

puts "Test now complete for Omag Subscription for News letter checked redirecting to originating page.This is for the skip offer button".green
f.puts "Test now complete for Omag Subscription for News letter checked redirecting to originating page.This is for the skip offer button"
...
browser.close
  ...
  puts e
  puts 'problem with form submission for Owners checked for new Ocom account' 
  f.puts 'problem with form submission for Omag Subscription for Owners checked for new Ocom account'
  f.puts ' ' 
 browser.close
 f.close
end
