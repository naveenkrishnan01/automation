...
def setup
 ...
 caps[:name] = "Testing own2.0 on Mac and Safari 6 safri not supporting drag and drop"
 @status = "false"
...
sleep 2;
 ...
 def teardown
 #if  @status == "false"
 #   RestClient.put("https://http://naveen1kris1:2062dca8-719e-4018-ad35-fdd2e7ad07ef@saucelabs.com/rest/v1/naveen1kris1/jobs/#{@session_id}", {"passed" => false}.to_json, {:content_type => "application/json"})
 #else
 #   RestClient.put("http://naveen1kris1:2062dca8-719e-4018-ad35-fdd2e7ad07ef@saucelabs.com/rest/v1/naveen1kris1/jobs/#{@session_id}", {"passed" => true}.to_json, {:content_type => "application/json"})
   @driver.quit
 end
