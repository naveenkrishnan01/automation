...
sleep 2;
browser.div(:id => 'agree_checkbox', :class => 'checkbox_icon').fire_event("onclick");
sleep 2;
browser.div(:class => 'btn_joinnow_ocom float', :id => 'submit_reg_btn').fire_event("onclick");
...
browser.div(:xpath => ".//*[@id='chk_73']").fire_event("onclick");
browser.button(:id => 'finish_btn', :class => 'ocom_button_dark').fire_event("onclick");
...
sleep 2;
browser.div(:id => 'newsletter_panel_switch_container').fire_event("onclick");
sleep 5;
